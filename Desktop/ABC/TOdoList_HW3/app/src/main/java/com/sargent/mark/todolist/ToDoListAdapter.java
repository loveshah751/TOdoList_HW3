...
public class ToDoListAdapter extends RecyclerView.Adapter<ToDoListAdapter.ItemHolder> {
    ...
    //Another oncheckClick Method is used to update done or not done
    ...
    public void swapCursor(Cursor newCursor){
        ...
        if (newCursor != null)
        {
            ...
            //RecyclerView forced to refresh
            this.notifyDataSetChanged();
        }
    }


// to get textview resources in the item holder I added the Textview which will return String
