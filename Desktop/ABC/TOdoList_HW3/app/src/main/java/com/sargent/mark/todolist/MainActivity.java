...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener,AdapterView.OnItemSelectedListener{
    ...
    protected void onStart() {
        ...
        adapter = new ToDoListAdapter(cursor, new ToDoListAdapter.ItemClickListener() {
            ...
            // Use the interface Method onCheckClick which will handle event of checkbox and make the todoAPP as done or not done
            ...
            public void onCheckClick(int pos,boolean status, long id){
                ...
                // To show the checkbox changes using swaping cursor
...
// Extra category Field is added and status is false bydefault
    ...
    // This Point adding Spinner in Menu item
    ...
    // Override onItemSelected it will determine which menu item is selected and then display result
    @Override
    ...
    // To perform Database query this method has been used based on two argument database name and selected category
